...
class Mdl_profession extends MY_Model {

	private $p_key = 'id';
	private $table = 'profession_master';
	private $alias = 'pm';
	private $fillable = ['name'];
    private $column_list = ['Profession Name', 'Created'];
    private $csv_columns = ['Profession Name', 'Created'];
	...
	function save(){
        ...
        $response['status'] = TRUE;
        $response['message'] = 'Congratulations! your Profession is saved with us!.';
        $response['redirectTo'] = 'profession/lists';

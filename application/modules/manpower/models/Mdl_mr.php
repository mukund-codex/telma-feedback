...
class Mdl_mr extends Manpower_Model {
		...
		if($type == 'save') {
			return [
                ...
                [
					'field' => 'users_city_id',
					'label' => 'City',
					'rules' => 'trim|required|check_record[city.city_id]|unique_record[add.table.manpower.users_type.'. $role .'.users_city_id.' . $this->input->post('users_city_id') . ']|xss_clean'
                ],
				[
					'field' => 'users_name',
					'label' => 'Name',
		...
		if($type == 'modify') {
            ...
            return [
				...
				[
					'field' => 'users_city_id',
					'label' => 'City',
					'rules' => 'trim|required|check_record[city.city_id]|unique_record[edit.table.manpower.users_type.'. $role .'.users_city_id.' . (int) $this->input->post('users_city_id') . '.users_id.'. $this->input->post('users_id') .']|xss_clean'
                ],
				[
					'field' => 'users_name',
					'label' => 'Name',
	...
	function save(){
		...
		$users_parent_info = $this->user_info($_POST['users_area_id'], 'ASM');

		...
		if($type == 'save') {
			return [
                ...
                [
					'field' => 'sender_id',
					'label' => 'Sender Id',
					'rules' => 'trim|required|alpha_numeric|unique_record[add.table.divisions.sender_id.' . $this->input->post('sender_id') .']|xss_clean'
				],
		...
		if($type == 'modify') {
			return [
                ...
                [
					'field' => 'sender_id',
					'label' => 'Sender Id',
					'rules' => 'trim|required|alpha_numeric|unique_record[edit.table.divisions.sender_id.' . $this->input->post('sender_id'). '.division_id.'. $this->input->post('division_id') .']|xss_clean'
                ],

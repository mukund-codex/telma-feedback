...
class Ajax_pagination{
   ...
   var $show_count      = true;
	...
	function initialize($params = array())
	{
		...
		{
			$this->anchor_class = 'class="waves-effect ' . $this->anchor_class . '" ';
		}
	}
	...
	function getAJAXlink( $count, $text) {
		...
		return "<a href=\"javascript:void(0);\"
		         " . $this->anchor_class . " data-count=\"$count\" data-page=\"$pageCount\" >"
				. $text .'</a>';
	}
}
